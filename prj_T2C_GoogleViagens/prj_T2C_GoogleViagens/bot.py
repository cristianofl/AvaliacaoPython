...
class Bot(WebBot):
    ...
    def action(self, execution=None):
        ...
        var_clssSendEmail = T2CSendEmail(arg_strEmailServerSmtp="smtp-mail.outlook.com", arg_intEmailPortaSmtp="587", arg_strUsuario="cristiano.lima@t2cgroup.com.br", arg_strSenha="Teste123",arg_strNomeProcesso=var_strNomeProcesso, arg_clssMaestro=var_clssMaestro)
        ...
        var_clssMaestro.write_log("Limpando fila.")
        var_clssSqliteQueue.abandon_queue()
        ...
        if(var_dictConfig["EmailFinal"].upper() == "SIM"):   
            caminho_excel_valores = 'prj_T2C_GoogleViagens/Precos_viagem.xlsx'
            var_clssSendEmail.send_email_final(arg_strHorarioInicio=var_strDatahoraInicio, arg_strHorarioFim=var_strDatahoraFim, arg_strEnvioPara=var_dictConfig["EmailDestinatarios"], arg_listAnexos=[caminho_excel_valores], arg_boolSucesso=True)
